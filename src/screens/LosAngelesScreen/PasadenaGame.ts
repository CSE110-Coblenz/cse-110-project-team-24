...
export function startPDGame(layer: Konva.Layer) {
  ...
  const question = new Konva.Text({
    text: "Which university is in Pasadena?",
    x: 30,
    y: 30,
    fontSize: 22,
    fontFamily: "Arial",
  ...
  const options = [
    { text: "A. Cal Poly", correct: false },
    { text: "B. UCLA", correct: false },
    { text: "C. USC", correct: false },
    { text: "D. Caltech", correct: true },
  ];
...
function nextQuestion(layer: Konva.Layer) {
  ...
  const question = new Konva.Text({
    text: "When does the Rose Parade take place every year?",
    x: 30,
    y: 30,
    fontSize: 22,
    fontFamily: "Arial",
  ...
  const options = [
    { text: "A. Thanksgiving", correct: false },
    { text: "B. Christmas", correct: false },
    { text: "C. New Year", correct: true },
    { text: "D. Lunar New Year", correct: false },
  ];
