...
export function startUSGame(layer: Konva.Layer) {
  ...
  const question = new Konva.Text({
    text: "What is the functionality of Union Station?",
    x: 30,
    y: 30,
    fontSize: 22,
    fontFamily: "Arial",
  ...
  const options = [
    { text: "A. Metro Station", correct: false },
    { text: "B. Bus Station", correct: false },
    { text: "C. Train Station", correct: false },
...
function nextQuestion(layer: Konva.Layer) {
  ...
  const options = [
    { text: "A. Union Pacific", correct: false },
    { text: "B. BNSF", correct: false },
    { text: "C. Southern Pacific", correct: false },
    { text: "D. Amtrak", correct: true },
  ];
