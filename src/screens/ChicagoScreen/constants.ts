...
export const MUSEUM_RADIUS = 60;
export const MUSEUM_LABEL_WIDTH = 120;
export const MUSEUM_LABEL_OFFSET_Y = 80;
export const MUSEUM_HIT_RADIUS = 70;
export const MUSEUM_FILL_COLOR = "#e1ecf7";
